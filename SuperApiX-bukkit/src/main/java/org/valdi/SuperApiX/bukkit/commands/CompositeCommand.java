...
public abstract class CompositeCommand extends Command implements PluginIdentifiableCommand, SuperCommand {
    ...
    public CompositeCommand(ISuperBukkitPlugin plugin, String label, String... aliases) {
        ...
        /*if (plugin.getBootstrap().getCommand(label) == null) {
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        User user = SimpleUser.getInstance(sender);
...
//        user.setAddon(addon);
    ...
    public List<String> tabComplete(final CommandSender sender, final String alias, final String[] args) {
        ...
        options.addAll(command.tabComplete(SimpleUser.getInstance(sender), alias, new LinkedList<>(Arrays.asList(args))).orElse(new ArrayList<>()));
        ...
        return CommandUtils.tabLimit(options, lastArg).stream().sorted().collect(Collectors.toList());
    }
