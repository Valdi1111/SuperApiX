...
public class AdvancementManager extends AbstractAdvancementManager<Advancement> {
    ...
    protected void addPlayer(Player player, SuperKey tab) {
        ...
        Collection<net.minecraft.server.v1_13_R2.Advancement> advs = new ArrayList<>();
        ...
        for(Advancement advancement : advancements) {
            ...
            if(tab == null || isTab) {
                ...
                if(!hidden || hiddenBoolean) {
                    ...
                    net.minecraft.server.v1_13_R2.Advancement adv = new net.minecraft.server.v1_13_R2.Advancement((MinecraftKey) advancement.getName().toMinecraftKey(), advancement.getParent() == null ? null : advancement.getParent().getSavedAdvancement(), advDisplay, advRewards, advCriteria, advRequirements);
    ...
    public void addAdvancement(Advancement... advancementsAdded) {
        HashMap<Player, Collection<net.minecraft.server.v1_13_R2.Advancement>> advancementsList = new HashMap<>();
        Set<MinecraftKey> remove = new HashSet<>();
        ...
        for(Advancement advancement : advancementsAdded) {
            ...
            net.minecraft.server.v1_13_R2.Advancement saveAdv = new net.minecraft.server.v1_13_R2.Advancement((MinecraftKey) advancement.getName().toMinecraftKey(), advancement.getParent() == null ? null : advancement.getParent().getSavedAdvancement(), saveDisplay, advRewards, advCriteria, advRequirements);
            ...
            for(Player player : getPlayers()) {
                ...
                Collection<net.minecraft.server.v1_13_R2.Advancement> advs = advancementsList.containsKey(player) ? advancementsList.get(player) : new ArrayList<>();
