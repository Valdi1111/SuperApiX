package org.valdi.SuperApiX.bukkit.nms.v1_13_R1.advancements;
...
public class AdvancementManager extends AbstractAdvancementManager<Advancement> {
        ...
        for(Advancement advancement : advancements) {
            ...
            if(tab == null || isTab) {
                ...
                if(!hidden || hiddenBoolean) {
                    ...
                    net.minecraft.server.v1_13_R1.Advancement adv = new net.minecraft.server.v1_13_R1.Advancement((MinecraftKey) advancement.getName().toMinecraftKey(), advancement.getParent() == null ? null : advancement.getParent().getSavedAdvancement(), advDisplay, advRewards, advCriteria, advRequirements);
    ...
    public void addAdvancement(Advancement... advancementsAdded) {
        ...
        for(Advancement advancement : advancementsAdded) {
            ...
            net.minecraft.server.v1_13_R1.Advancement saveAdv = new net.minecraft.server.v1_13_R1.Advancement((MinecraftKey) advancement.getName().toMinecraftKey(), advancement.getParent() == null ? null : advancement.getParent().getSavedAdvancement(), saveDisplay, advRewards, advCriteria, advRequirements);
