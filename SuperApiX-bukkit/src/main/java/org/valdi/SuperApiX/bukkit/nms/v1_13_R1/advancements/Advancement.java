...
public class Advancement extends AbstractAdvancement<net.minecraft.server.v1_13_R1.Advancement, AdvancementProgress, Criterion> {
    ...
    public void displayToast(Player player) {
        ...
        AdvancementDisplay display = this.getDisplay();
        ...
        net.minecraft.server.v1_13_R1.AdvancementDisplay saveDisplay = new net.minecraft.server.v1_13_R1.AdvancementDisplay(icon, (IChatBaseComponent) display.getTitle(), (IChatBaseComponent) display.getDescription(), backgroundTexture, (AdvancementFrameType) display.getFrame().getNMS(), display.isToastShown(), display.isAnnouncedToChat(), true);
        net.minecraft.server.v1_13_R1.Advancement saveAdv = new net.minecraft.server.v1_13_R1.Advancement(notName, this.getParent() == null ? null : this.getParent().getSavedAdvancement(), saveDisplay, advRewards, advCriteria, advRequirements);
