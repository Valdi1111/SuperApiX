...
public interface IDatabasesProvider {
	 ...
	 */
	IDataStorage createSqLiteDatabase(StoreLoader loader, File path, String name) throws DatabaseException;
	 ...
	 * @throws DatabaseException if any exception is thrown during database creation
	 */
	IDataStorage createH2Database(StoreLoader loader, File path, String name) throws DatabaseException;
